        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav">
            ...
            <form action="index.php" method="post">
                <button type="submit" name="juego1" class="p-3 text-decoration-none text-light bg-dark"  value="adivina">Adivina el numero</button>
            </form>
            <a href="Adivina2/index1.php" class="p-3 text-decoration-none text-light">Adivina el numero</a>
            <a href="inicio.html" class="p-3 text-decoration-none text-light">Piedra Papel o Tijeras</a>
            <a href="form.html" class="p-3 text-decoration-none text-light">El Ahorcado</a>
          </div>
        </div>
      </nav>
...
<div class="jumbotron bg-transparent mb-0 radius-0">
  <div class="container">
      <div class="row">
        <div class="col-xl-6">
          <h1 class="display-2">Neon Glo<span class="vim-caret">w</span></h1>
...
<?php
 if(isset($_REQUEST['juego1'])=='adivina')
 {
   include "Adivina2/modelo.php";
  $m= new Modelo();
  $m->generateRand();
  header("location:Adivina2/index1.php");
  //echo $m->getNumero();
